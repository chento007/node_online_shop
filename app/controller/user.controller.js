...
const generateAccessToken = (userData) => {
    return jwt.sign(userData, local_token, { expiresIn: '15m' }); // Set the expiration time as needed
};

const generateRefreshToken = (userData) => {
    return jwt.sign(userData, local_token, { expiresIn: '7d' }); // Set the expiration time as needed
};
